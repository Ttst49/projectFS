 ...
 */
final class Version20240418075049 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event ADD CONSTRAINT FK_3BAE0AA77E3C61F9 FOREIGN KEY (owner_id) REFERENCES profile (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
